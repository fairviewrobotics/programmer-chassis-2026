...
public class SwerveConstants {
    ...
    public static final int REAR_LEFT_DRIVING_CAN_ID = 14;
    ...
    public static final double ROBOT_MASS_KG = Units.lbsToKilograms(30);
    public static final double ROBOT_MOI = 0;

    public static final double WHEEL_RADIUS_METERS = 0;
    public static final double MAX_DRIVE_VELOCITY_MPS = 5;
